...
var cookietypes = ['Chocolate Chip Cookie', 'Extreme Chocolato', 'Macadamia Nut', 'Cookie From The Past', "Mrs. Claus's Cookie", 'Edible Football Field']
...
var cookiebenefits = {
  ...
  'Edible Football Field': "+1 auto clicker every click. (Auto Clicker: Clicks 1 per minute)"
}
...
function upgradecookie() {
  ...
  if(cookies<cost) {
    alert('You need ' + cost + ' cookies to upgrade to the ' + cookietypes[index] + '.');
  } else { 
    ...
    alert('You upgraded to the ' + cookietype + '.\nBenefit: ' + cookiebenefits[cookietype])
